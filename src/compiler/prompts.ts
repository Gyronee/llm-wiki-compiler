...
export function buildExtractionPrompt(
  ...
  return [
    ...withLangLine(
      ...
      "Do not extract a concept that is only named, teased, promised for later, or used as a cross-reference without enough local explanation in this source.",
...
export function buildPagePrompt(
  ...
  return [
    ...withLangLine(
      ...
      "Do not create placeholder [[wikilinks]]. Only use [[wikilinks]] for pages that appear in the related wiki pages provided below.",
    ...
    "Place citations at the end of prose paragraphs or sentences. Every factual bullet or numbered list item must end with a citation.",
    "Do not put citations on headings or code blocks.",
    "Do not leave material claims uncited. If the source material does not support a claim with identifiable lines, omit the claim.",
    ...
    "",
    "Do not fill gaps with uncited inference. If the source only names, teases, or cross-references a topic without explaining it, write a brief note that source context is insufficient rather than inventing a full page.",
    existingSection,
    relatedSection,
    "\n\n--- SOURCE MATERIAL ---\n\n",
    sourceContent,
